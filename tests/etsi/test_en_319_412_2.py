...
def test_setting_d():
    ...
    assert (
        e.value.finding
        == pkilint.etsi.etsi_shared.KeyUsageValidator.VALIDATION_MIXED_KEY_USAGE_SETTING
    )
...
def test_invalid_extra_bit():
    ...
    assert (
        e.value.finding
        == pkilint.etsi.etsi_shared.KeyUsageValidator.VALIDATION_UNKNOWN_KEY_USAGE_SETTING
    )
