    ...
    validator = crl.create_pkix_crl_validator_container(
        ...
        [
            ...
            crl.create_validity_validator_container(
                [cabf_crl.create_validity_period_validator(crl.CertificateRevocationListType.ARL)]
            ),
        ...
        [
            cabf_crl.CabfCrlReasonCodeAllowlistValidator(crl.CertificateRevocationListType.ARL)
        ]
    )
