...
def _match_to_datetime(m):
    ...
    return datetime(date_components['year'], date_components['month'],
                    date_components['day'], date_components['hour'],
                    date_components['minute'], date_components['second'], 0,  # msec
                    timezone.utc)
...
class UtcTimeCorrectSyntaxValidator(validation.Validator):
    ...
    def __init__(self):
        super().__init__(pdu_class=useful.UTCTime,
...
class GeneralizedTimeCorrectSyntaxValidator(validation.Validator):
    ...
    def __init__(self):
        super().__init__(pdu_class=useful.GeneralizedTime,
                         validations=[self.VALIDATION_INCORRECT_SYNTAX]
                         )
