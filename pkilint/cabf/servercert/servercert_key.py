...
class CabfAllowedSignatureAlgorithmEncodingValidator(
    ...
    VALIDATION_DISALLOWED_SIGNATURE_ENCODING = validation.ValidationFinding(
        ...
        'cabf.br_prohibited_signature_algorithm_encoding'
    )
...
class CabfAllowedPublicKeyAlgorithmEncodingValidator(
    ...
    VALIDATION_DISALLOWED_PUBKEY_ALG_ENCODING = validation.ValidationFinding(
        validation.ValidationFindingSeverity.ERROR,
        'cabf.prohibited_subject_public_key_algorithm_encoding'
    )
