...
ALLOWED_SIGNATURE_ALGORITHM_ENCODINGS = set(
    map(
        ...
        [
            ...
            "300506032b6571",
            # ML‐DSA‐44
            "300b0609608648016503040311",
            # ML‐DSA‐65
            "300b0609608648016503040312",
            # ML‐DSA‐87
            "300b0609608648016503040313",
        ],
    )
)
...
ALLOWED_SPKI_ENCODINGS = set(
    map(
        ...
        [
            ...
            "300b0609608648016503040313",
            # ML-KEM-512
            "300b0609608648016503040401",
            # ML-KEM-768
            "300b0609608648016503040402",
            # ML-KEM-1024
            "300b0609608648016503040403",
        ],
    )
)
