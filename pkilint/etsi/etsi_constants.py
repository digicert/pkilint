...
QEVCP_W_PSD2_EIDAS_CERTIFICATE_TYPES = {CertificateType.QEVCP_W_PSD2_EIDAS_PRE_CERTIFICATE,
...
WEB_AUTHENTICATION_CERTIFICATE_TYPES = CABF_CERTIFICATE_TYPES | QWAC_TYPES
