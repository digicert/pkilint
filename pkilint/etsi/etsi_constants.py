...
class CertificateType(enum.IntEnum):
    ...
    QNCP_W_GEN_LEGAL_PERSON_PSD2_EIDAS_PRE_CERTIFICATE = auto()
    ...
    QNCP_W_GEN_LEGAL_PERSON_PSD2_EIDAS_FINAL_CERTIFICATE = auto()
    ...
    QCP_N_QSCD_EIDAS_FINAL_CERTIFICATE = auto()
    QCP_N_QSCD_NON_EIDAS_FINAL_CERTIFICATE = auto()
...
# TS 119 495, clause 6.1, OVR-6.1-3 permits the QCP-w-psd2 policy identifier to augment QNCP-w-gen, and
# OVR-6.1-3A states that the QNCP-w-gen policy requirements apply to certificates issued for use in TLS
# authentication outside the context of a web browser.
QNCP_W_GEN_LP_PSD2_EIDAS_CERTIFICATE_TYPES = {
...
QCP_N_QSCD_CERTIFICATE_TYPES = {
    CertificateType.QCP_N_QSCD_EIDAS_FINAL_CERTIFICATE,
    CertificateType.QCP_N_QSCD_NON_EIDAS_FINAL_CERTIFICATE,
}
...
PSD2_EIDAS_CERTIFICATE_TYPES = (
    QEVCP_W_PSD2_EIDAS_CERTIFICATE_TYPES | QNCP_W_GEN_LP_PSD2_EIDAS_CERTIFICATE_TYPES
)
...
EU_SSCD_TYPES = {CertificateType.QCP_N_QSCD_EIDAS_FINAL_CERTIFICATE}

EU_TYPES = EU_QWAC_TYPES | EU_SSCD_TYPES
